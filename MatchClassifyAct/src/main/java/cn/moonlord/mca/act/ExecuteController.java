...
public class ExecuteController {
    ...
    /** 实时切换鼠标点击方式（mumu=MuMu 模拟器 / screen=MouseEvent 前台点击 / rawinput=RawInput 前台点击
     *  / post=PostMessage 后台消息 / sendmessage=PostMessage 后台消息+移动窗口）。 */
     ...
     *  保存前与 resource/capture/ + resource/classify/ 全部同尺寸 PNG 全尺寸逐像素比对、统计不一致像素点占比（阈值
    ...
    /** 把最近一次识别画面另存为 resource/capture/ 下的原始截图（未标注）：需人工精确标注 / 修正坐标时，
