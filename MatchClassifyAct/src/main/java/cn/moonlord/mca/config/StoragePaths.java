 ...
 *   summary/   汇总分析产物：&lt;分类标注&gt;/ 下对照图（14 张基础合成图 = 交集五档 same90/80/70/60/50
 *              与多数/均值/去重均值/8·32 块图族，全部参与识别比对；每张基础图各带 1 张 -unique
 *              独有区图共 14 张，同样全部参与比对；点击动作且有坐标的分类另有最多 10 张点击区交集图
 *              click8/32-same90/80/70/60/50，全部参与比对）+ info.json
 * </pre>
 *
