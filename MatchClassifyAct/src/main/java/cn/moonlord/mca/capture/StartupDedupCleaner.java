 ...
 *
 * <p>就绪事件（ApplicationReadyEvent）晚于全部 ApplicationRunner 执行——含旧版单目录
 * {@code config/LegacyStorageMigrator} 的迁移——因此触发时 capture/ classify/ summary/
 * 三阶段目录已就位、旧 captures/ 数据已归位，本次清理一次即可覆盖全量历史截图；
