...
└─ src/main/
   ...
   │  │  └─ StartupDedupCleaner.java         ApplicationReadyEvent：后台执行启动历史重复清理（按自动 / 手动两阈值中较大者删历史重复）+ 去重基准缩略缓存预热
