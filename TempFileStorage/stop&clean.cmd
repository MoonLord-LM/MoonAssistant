...
chcp 65001
rem ============================================================
rem  TempFileStorage service : STOP + CLEAN helper
rem  Ends the java process running TempFileStorage jar, then
rem  removes the target\ build output (forces a full rebuild
rem  next time, e.g. "restart.cmd").
rem
rem  Usage:
