...
chcp 65001
rem ============================================================
rem  TempFileStorage service : START / RESTART helper
rem
...
rem
rem  Web pages: http://localhost:8080/disk/show  http://localhost:8080/video/show
...
powershell -NoProfile -ExecutionPolicy Bypass -Command "$base='%~dp0'; New-Item -ItemType Directory -Force -Path ($base+'log') | Out-Null; Start-Process -FilePath '%JAVA_BIN%' -ArgumentList '-Xmx4g','-Dfile.encoding=UTF-8','-jar','target\TempFileStorage-0.0.1-SNAPSHOT.jar' -WorkingDirectory $base -WindowStyle Hidden -RedirectStandardOutput ($base+'log\std.log') -RedirectStandardError ($base+'log\error.log')"
